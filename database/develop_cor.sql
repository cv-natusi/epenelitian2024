...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Bulan Mei 2021 pada 04.58
...
--
-- Struktur dari tabel `author_submits`
--
...
--
-- Dumping data untuk tabel `doc_hasil`
--
...
--
-- Struktur dari tabel `jenis_file_pendukung`
--
...
--
-- Dumping data untuk tabel `jenis_file_pendukung`
--
...
--
-- Struktur dari tabel `jenis_hasil`
--
...
--
-- Dumping data untuk tabel `jenis_hasil`
--
...
--
-- Struktur dari tabel `lembar_konfirmasi`
--
...
--
-- Dumping data untuk tabel `lembar_konfirmasi`
--
...
--
-- Struktur dari tabel `supplementaries`
--
...
--
-- Struktur dari tabel `tempat_penelitian`
--
...
--
-- Dumping data untuk tabel `tempat_penelitian`
--
...
(1, 'admin', 'dinkessidoarjo46@gmail.com', '$2y$10$RvXEOXNLUqfdIR2OdHBVY.NDTsCB2wgQHHFQ7b8RP0V5egAaArrdW', '1', 0, 0, 'Q3bDly0Oy9OEQ90Rua7PiDADVelpb8z7VERWwzAkZ99lHhA8dOJKi7wJ58j1', NULL, NULL),
(2, 'kasi', 'kasi@gmail.com', '$2y$10$.Z9FFo.FgmYJmVwwhbT7Ee9roMsZwF5wh4zj16/u4gvbt4WKWPI7O', '2', 0, 0, '7ttPKIFO51O9tsZleUhrbN7f2pCkatF6yxmt4hfaCWpZyz6jvST0vPxC4iEs', NULL, NULL),
...
(20, 'pkm_sidoarjo', 'pkm_sidoarjo@gmail.com', '$2y$10$LGxKO0dLfMKfuHzVWaUPFuXdcpBCzHVxY83S9StimHea15kIJChJ.', '6', 16, 0, '8HrywqCIbDw8avPR3DMi5qQj3iv1o5GdpJ0zzTXlsuBJ1m6FeSOHsicucJuX', NULL, NULL),
(21, 'pkm_urangagung', 'pkm_urangagung@gmail.com', '$2y$10$5MkJ9TjxrAUrGCygNv6NX.ZQpRDRaOUTozT3l/U.1pLPdWeN4Pf1C', '6', 17, 0, '1hDkz1dRW7johDSby4417Hn0pkQBHol7bJulhrGV56t6GdVigvhWBfvJgTHL', NULL, NULL),
...
--
-- Struktur dari tabel `verifikasi_tempat_penelitian`
--
...
--
-- Dumping data untuk tabel `verifikasi_tempat_penelitian`
--
...
--
-- Indeks untuk tabel `author_submits`
--
...
--
-- Indeks untuk tabel `jenis_file_pendukung`
--
ALTER TABLE `jenis_file_pendukung`
  ADD PRIMARY KEY (`id_jenis_file`);

--
-- Indeks untuk tabel `jenis_hasil`
--
...
--
-- Indeks untuk tabel `lembar_konfirmasi`
--
...
--
-- Indeks untuk tabel `supplementaries`
--
ALTER TABLE `supplementaries`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tempat_penelitian`
--
...
--
-- Indeks untuk tabel `verifikasi_tempat_penelitian`
--
...
--
-- AUTO_INCREMENT untuk tabel `author_submits`
--
ALTER TABLE `author_submits`
...
--
-- AUTO_INCREMENT untuk tabel `doc_hasil`
--
ALTER TABLE `doc_hasil`
...
--
-- AUTO_INCREMENT untuk tabel `jenis_file_pendukung`
--
ALTER TABLE `jenis_file_pendukung`
  MODIFY `id_jenis_file` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `jenis_hasil`
--
ALTER TABLE `jenis_hasil`
...
--
-- AUTO_INCREMENT untuk tabel `lembar_konfirmasi`
--
ALTER TABLE `lembar_konfirmasi`
...
--
ALTER TABLE `permohonan`
  MODIFY `id_permohonan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT untuk tabel `supplementaries`
--
ALTER TABLE `supplementaries`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tempat_penelitian`
--
ALTER TABLE `tempat_penelitian`
...
--
-- AUTO_INCREMENT untuk tabel `verifikasi_tempat_penelitian`
--
ALTER TABLE `verifikasi_tempat_penelitian`
  MODIFY `id_verifikasi_tp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
